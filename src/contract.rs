...
use crate::msg::{
    EnumMigrateMsg, ExecuteMsg, InstantiateMsg, MigrateMsg, ModifyMsg, QueryMsg, Validate,
};
...
mod tests {
    ...
    fn execute_modify_contract_valid() {
        ...
        let modify_contract_msg = EnumMigrateMsg::Modify {
        ...
        let modify_contract_response = migrate(deps.as_mut(), mock_env(), modify_contract_msg);
    ...
    #[test]
    fn execute_modify_contract_valid_active_orders() {
        let mut deps = mock_dependencies(&[]);
        ...
        setup_test_base(
            ...
            &ContractInfoV3 {
                ...
                convertible_base_denoms: vec!["con_base_1".into(), "con_base_2".into()],
                supported_quote_denoms: vec!["quote_1".into(), "quote_2".into()],
                approvers: vec![Addr::unchecked("appr_1"), Addr::unchecked("appr_2")],
                executors: vec![Addr::unchecked("exec_1"), Addr::unchecked("exec_2")],
                ask_fee_info: None,
                bid_fee_info: None,
                ask_required_attributes: vec!["ask_tag_1".into(), "ask_tag_2".into()],
        ...
        let bidder_info = mock_info("bidder", &[coin(200, "quote_1")]);
        let create_bid_msg = ExecuteMsg::CreateBid {
            id: "ab5f5a62-f6fc-46d1-aa84-51ccc51ec478".into(),
            base: "base_denom".to_string(),
            fee: None,
            price: "2".into(),
            quote: "quote_1".to_string(),
        ...
        let modify_contract_msg = EnumMigrateMsg::Modify {
            approvers: Some(vec!["appr_1".into(), "appr_2".into(), "appr_3".into()]),
