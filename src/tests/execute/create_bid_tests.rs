...
mod create_bid_tests {
    ...
    use cosmwasm_std::{Addr, attr, Binary, Coin, coin, coins, from_binary, Uint128};
    use provwasm_mocks::mock_dependencies;
    use provwasm_std::{Marker, transfer_marker_coins};
    use crate::bid_order::{BidOrderV2, get_bid_storage_read};
    ...
    fn create_bid_with_restricted_marker_valid_data() {
        ...
        let test_marker: Marker = from_binary(&Binary::from(QUOTE1_RESTRICTED_MARKER_JSON.as_bytes())).unwrap();
    ...
    fn create_bid_restricted_quote_denom_and_quote_mismatch_order_amount_and_size() {
        ...
        let create_bid_msg = ExecuteMsg::CreateBid {
            ...
            price: "3".into(),
            quote: "quote_1".into(),
            quote_size: Uint128::new(200), // TODO this should be 300
            size: Uint128::new(100),
        };
